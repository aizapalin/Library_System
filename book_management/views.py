...
def add_author(request):
    ...
    if request.method == "POST":
        ...
        if "delete_author" in request.POST:
            ...
            return redirect("book_management:add_author")
    ...
    return render(request, "book_management/add_author.html", {"authors": Author.objects.all()})
...
def add_category(request):
    ...
    if request.method == "POST":
        if "delete_category" in request.POST:
            ...
            return redirect("book_management:add_category")
    ...
    return render(request, "book_management/add_category.html", {"categories": Category.objects.all()})
